...
//
// Counters are in KiB; results are stored in the txGiBps/rxGiBps fields
// as GiB/s. Negative deltas from counter overflow are clamped to 0,
// with an optional stderr warning when verbose == true.
