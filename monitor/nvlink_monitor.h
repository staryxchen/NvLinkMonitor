...
public:
     ...
     * @param outputFilename Optional output file name (empty for console output)
     * @throws std::runtime_error if NVML initialization fails or file cannot be opened
     */
    ...
    std::vector<GPUMonitorResult> calculateBandwidth(
        ...
        const std::vector<GPUMonitorResult>& snapshot2,
        double timeDelta
    );
